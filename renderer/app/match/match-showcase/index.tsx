      ...
      {match && map && agents && player && agent && tiers && (
        <Card className="h-full flex-1">
          <CardContent className="flex flex-1">
            <Tabs className="flex w-full flex-1" defaultValue="overall">
              <TabsList className="w-full grow-0 overflow-hidden scroll-auto">
              ...
              <TabsContent value="overall" className="flex flex-1">
              ...
              {match.rounds.map((round) => (
                <TabsContent value={round.id.toString()}>
                  <RoundShowcase
                    round={round}
                    agents={agents}
                    players={match.players}
